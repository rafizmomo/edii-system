                ...
                <div class="card-body">
                    ...
                    @endif
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <input id="nama" type="text" class="form-control @error('nama') is-invalid @enderror" name="nama" value="{{ Auth::user()->biodata->posisi }}" readonly required autocomplete="nama">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <input id="nama" type="text" class="form-control @error('nama') is-invalid @enderror" name="nama" value="{{ Auth::user()->biodata->nama }}" readonly required autocomplete="nama">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <input id="no_ktp" type="text" class="form-control @error('no_ktp') is-invalid @enderror" name="no_ktp" value="{{  Auth::user()->biodata->no_ktp }}" readonly required autocomplete="no_ktp">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4">
                                <input id="tempat_lahir" type="text" class="form-control @error('tempat_lahir') is-invalid @enderror" name="tempat_lahir" value="{{  Auth::user()->biodata->tempat_lahir }}"readonly required autocomplete="tempat_lahir">
                            ...
                            <div class="col-md-4">
                                <input id="tanggal_lahir" type="date" class="form-control @error('tanggal_lahir') is-invalid @enderror" name="tanggal_lahir" value="{{  Auth::user()->biodata->tanggal_lahir }}"readonly required autocomplete="tanggal_lahir">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="mt-2">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" name="jenis_kelamin" type="radio" id="radioJKL" value="l" {{ Auth::user()->biodata->jenis_kelamin == 'l' ?  'checked' : 'disabled'}} >
                                        <label class="form-check-label" for="inlineCheckbox1">Laki-Laki</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" name="jenis_kelamin" type="radio" id="radioJKP" value="p" {{ Auth::user()->biodata->jenis_kelamin == 'p' ?  'checked' : 'disabled'}} >
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <input id="agama" type="text" class="form-control @error('agama') is-invalid @enderror" name="agama" value="{{ Auth::user()->biodata->agama }}" readonly required autocomplete="agama">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <div class="mt-2">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" name="golongan_darah" type="radio" id="radioGDA" value="a" {{ Auth::user()->biodata->golongan_darah == 'a' ?  'checked' : 'disabled'}} >
                                        <label class="form-check-label" for="radioGDA">A</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" name="golongan_darah" type="radio" id="radioGDB" value="b" {{ Auth::user()->biodata->golongan_darah == 'b' ?  'checked' : 'disabled'}} >
                                        <label class="form-check-label" for="radioGDB">B</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" name="golongan_darah" type="radio" id="radioGDAB" value="ab" {{ Auth::user()->biodata->golongan_darah == 'ab' ?  'checked' : 'disabled'}} >
                                        <label class="form-check-label" for="radioGDAB">AB</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" name="golongan_darah" type="radio" id="radioGDO" value="o" {{ Auth::user()->biodata->golongan_darah == 'o' ?  'checked' : 'disabled'}} >
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <input id="status" type="text" class="form-control @error('status') is-invalid @enderror" name="status" value="{{   Auth::user()->biodata->status }}" readonly required autocomplete="status">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <textarea id="alamat_ktp" type="text" class="form-control @error('alamat_ktp') is-invalid @enderror" name="alamat_ktp"  readonly autocomplete="alamat_ktp">{{  Auth::user()->biodata->alamat_ktp }}</textarea>
                                @error('alamat_ktp')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <textarea id="alamat_tinggal" type="text" class="form-control @error('alamat_tinggal') is-invalid @enderror" name="alamat_tinggal" readonly required autocomplete="alamat_tinggal">{{  Auth::user()->biodata->alamat_tinggal }}</textarea>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{  Auth::user()->biodata->email }}" readonly required autocomplete="email">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="no_telp" type="tel" class="form-control @error('no_telp') is-invalid @enderror" name="no_telp" value="{{  Auth::user()->biodata->no_telp }}" readonly required autocomplete="no_telp">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <input id="kontak_darurat" type="text" class="form-control @error('kontak_darurat') is-invalid @enderror" name="kontak_darurat" value="{{ Auth::user()->biodata->kontak_darurat }}" readonly required autocomplete="kontak_darurat">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-12 mt-2">
                                <table class="table table-bordered" id="dynamicPendidikan">
                                    ...
                                    @forelse (Auth::user()->biodata->ne_pendidikan as $pendidikan)
                                    <tr>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-12 mt-2">
                                <table class="table table-bordered" id="dynamicPelatihan">
                                    ...
                                    @forelse (Auth::user()->biodata->ne_pelatihan as $pelatihan)
                                    <tr>
                            ...
                            <div class="col-md-12 mt-2">
                                <table class="table table-bordered" id="dynamicPekerjaan">
                                    <tr>
                                        ...
                                        @forelse (Auth::user()->biodata->ne_pekerjaan as $pekerjaan)
                                        <tr>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <textarea id="keahlian" type="text" class="form-control @error('keahlian') is-invalid @enderror" name="keahlian" readonly required autocomplete="keahlian">{{ Auth::user()->biodata->keahlian }}</textarea>
                                @error('keahlian')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <div class="mt-2">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" name="persetujuan_penempatan" type="radio" id="radioPTY" value="y" {{ Auth::user()->biodata->persetujuan_penempatan == 'y' ?  'checked' : 'disabled'}} >
                                        <label class="form-check-label" for="radioPTY">Ya</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" name="persetujuan_penempatan" type="radio" id="radioPTN" value="n" {{ Auth::user()->biodata->persetujuan_penempatan == 'n' ?  'checked' : 'disabled'}} >
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <input id="harapan_gaji" type="text" class="form-control @error('harapan_gaji') is-invalid @enderror" name="harapan_gaji" value="{{ Auth::user()->biodata->harapan_gaji }}" readonly required autocomplete="harapan_gaji">
